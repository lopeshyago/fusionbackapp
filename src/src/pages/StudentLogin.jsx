      ...
      <header className="bg-black text-white p-4 shadow-xl">
        <div className="container mx-auto flex justify-between items-center">
          <div className="flex items-center gap-3">
            ...
            <span className="text-xl font-bold text-white">Login Aluno</span>
          </div>
      ...
      <div className="flex items-center justify-center p-4 min-h-[calc(100vh-80px)]">
        <Card className="w-full max-w-md shadow-2xl border-orange-200">
          <CardHeader className="text-center">
            ...
            <CardTitle className="text-2xl font-bold">Acesso Aluno</CardTitle>
            <CardDescription>
              Entre com suas credenciais de aluno para acessar o painel de controle.
            </CardDescription>
          </CardHeader>
          <CardContent>
